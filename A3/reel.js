...
function horizons() {
    ...
    g.select("circle").transition()
            .duration(duration)
            .attr("transform", function(d) { return "translate(" + (w - 200) + "," + (-h / 4) + ")"; })
            .remove();

    g.select("text").transition()
            .duration(duration)
            .attr("transform", function(d) { return "translate(" + (w - 200) + "," + (h / 4 - 20) + ")"; })
            .attr("dy", "0em");
...
var thankyou =["Thank you for watching!"]
function Thankyou(){
    var svg = d3.select("body").append("svg")
        .attr("width", 1000)
        .attr("height", 300);
